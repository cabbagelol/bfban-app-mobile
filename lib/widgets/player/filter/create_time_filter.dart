...
class CreateTimeFilterPanelState extends State<CreateTimeFilterPanel> {
  ...
  void initState() {
    widget.data ??= FilterPanelData(
      values: [null, null],
      names: ["createTimeFrom", "createTimeTo"],
    );
            ...
            Container(
              ...
              child: SfDateRangePicker(
                ...
                monthCellStyle: DateRangePickerMonthCellStyle(
                  ...
                  blackoutDateTextStyle: const TextStyle(color: Colors.yellow),
                  trailingDatesTextStyle: const TextStyle(color: Colors.yellow),
                ),
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(FlutterI18n.translate(context, "list.reportTime")),
