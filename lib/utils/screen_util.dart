...
class ScreenUtil {
  ...
  static double _statusBarHeight = 0.floorToDouble();

  static double _bottomBarHeight = 0.floorToDouble();

  static double _textScaleFactor = 0.floorToDouble();

  ScreenUtil({required int width, required int height}) {
    _designWidth = width;
